...
<body>
    ...
    <center>
        ...
        <form action="" method="post">
            <table>
                <tr>
                    <td colspan="2" style="background-color:#E06815; padding-bottom:5px; padding-top:5px;"><label>INICIO DE SESION</label></td>
                </tr>
                <tr>
...
$query = mysqli_query($conect,"SELECT * FROM login WHERE usuario = '".$nombre."'and password ='".$pass."'");
